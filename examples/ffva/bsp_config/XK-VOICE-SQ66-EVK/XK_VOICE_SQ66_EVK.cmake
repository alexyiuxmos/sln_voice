...
add_library(sln_voice_app_ffva_board_support_xk_voice_sq66 INTERFACE)
target_sources(sln_voice_app_ffva_board_support_xk_voice_sq66
    INTERFACE
...
target_include_directories(sln_voice_app_ffva_board_support_xk_voice_sq66
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}
)
target_link_libraries(sln_voice_app_ffva_board_support_xk_voice_sq66
    INTERFACE
        core::general
        rtos::freertos
        ...
        sln_voice::app::ffva::dac::dac3101
)
target_compile_options(sln_voice_app_ffva_board_support_xk_voice_sq66
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/xvf3800_qf60.xn
)
target_link_options(sln_voice_app_ffva_board_support_xk_voice_sq66
    INTERFACE
        ${CMAKE_CURRENT_LIST_DIR}/xvf3800_qf60.xn
)
target_compile_definitions(sln_voice_app_ffva_board_support_xk_voice_sq66
    INTERFACE
        XK_VOICE_L71=1
...
## Create an alias
add_library(sln_voice::app::ffva::xk_voice_sq66 ALIAS sln_voice_app_ffva_board_support_xk_voice_sq66)

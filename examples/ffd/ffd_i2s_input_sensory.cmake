...
#    appconfINTENT_I2C_SLAVE_POLLED_ENABLED=0
#    appconfINTENT_I2C_MASTER_OUTPUT_ENABLED=1
#    appconfI2C_MASTER_DAC_ENABLED=1
...
# Tile Targets
#**********************
set(TARGET_NAME tile0_example_ffd_i2s_input_sensory)
...
set(TARGET_NAME tile1_example_ffd_i2s_input_sensory)
add_executable(${TARGET_NAME} EXCLUDE_FROM_ALL)
target_sources(${TARGET_NAME} PUBLIC ${APP_SOURCES})
target_include_directories(${TARGET_NAME} PUBLIC ${APP_INCLUDES} ${RTOS_CONF_INCLUDES})
...
# Merge binaries
#**********************
merge_binaries(example_ffd_i2s_input_sensory tile0_example_ffd_i2s_input_sensory tile1_example_ffd_i2s_input_sensory 1)

#**********************
# Create run and debug targets
#**********************
create_run_target(example_ffd_i2s_input_sensory)
create_debug_target(example_ffd_i2s_input_sensory)

#**********************
# Create data partition support targets
#**********************
set(TARGET_NAME example_ffd_i2s_input_sensory)
